...
public class Course4View extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_course4);
        ...
        up_rv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Course4View.this, ReviewActivity.class);
        ...
        up_photo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Course4View.this, ImageActivity.class);
                startActivity(intent);
            }
        });
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng latLng = new LatLng(35.17757405249098, 128.14175476780713);
